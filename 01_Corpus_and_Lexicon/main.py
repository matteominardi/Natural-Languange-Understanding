...
if __name__ == "__main__":
    ...
    print_desc_statistics(words, sents)
    print("-------------------------------------------------------")
    ...
    print_desc_statistics(words_spacy, sents_spacy)
    print("-------------------------------------------------------")
    ...
    print_desc_statistics(words_nltk, sents_nltk)
    print("-------------------------------------------------------")
    ...
    print("Reference n best:", nbest(lex_freq_list, n))
    print("Spacy n best:", nbest(lex_freq_list_spacy, n))
    print("NLTK n best:", nbest(lex_freq_list_nltk, n))