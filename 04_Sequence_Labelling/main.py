...
if __name__ == "__main__":
    ...
    experiment("\nBASELINE", trn_data, val_data, tst_data, 1)
    experiment("\nHIGHER CUTOFF", trn_data, val_data, tst_data, 2)
    experiment("\nBACKOFF WITH NO DEFAULT TAGGER", trn_data, val_data, tst_data, 1, True)
    experiment("\nBACKOFF WITH DEFAULT TAGGER", trn_data, val_data, tst_data, 1, True, nltk.DefaultTagger('NOUN'))
