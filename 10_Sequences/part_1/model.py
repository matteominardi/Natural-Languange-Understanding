...
class ModelIAS(nn.Module):
    def __init__(self, hid_size, out_slot, out_int, emb_size, vocab_len, n_layer=1, pad_index=0,
        ...
        hid_size = hid_size * 2 if bidirectional else hid_size
...
def save_model(model, bidirectional, dropout):
    bid = "_bidirectional" if bidirectional else "_no_bidirectional"
    drop = "_dropout" if dropout else "_no_dropout"
    path = "bin/model" + bid + drop + ".pt"
